...
mysqli_query($db,"update tblfertsession set fdate='$f',fert_name='$txtfert',Aqty_app='$txtaqty',ARec_qty='$txtrqty',qty_app='$v',Rec_qty='$w',reduce_qty='$txtreduce',unit='$u',act_unit='$txtaunit',fert_reason='$txtreason',purchase_rate='$txtrate',total='$tot',method_app='$m',plot_no='$pno',status=0 where fid=".$_GET["id1"]);


mysqli_query($db,"update tblp1 set reduce_qty='$txtreduce' where  item_name='".$txtfert."'");
}
else
{
echo "<script>alert('Quantity Exceeds Stock Limit'); </script>";  
      ...
      echo "<script>window.location.href='edit_fertilizer3.php?id=$fid'</script>";
       exit;    
...
<?php
$q1=mysqli_query($db,"select * from tblfertsession where fid=".$_GET['id1']); 
     ...
     <th style="border: 1px solid black;">Quantity Applied</th>
      ...
      <th style="border: 1px solid black;">Reason Of Fertigation</th>
             ...
             <tbody>
               ...
               <option value="<?php echo $r1['fert_name'];?>"selected><?php echo $r1['fert_name'];?>
            ...
            <div id="item_name"></div>
              ...
              <td style="border: 1px solid black;"><input type="text" name="txtaqty" id="aqty_1" class="aqty" onclick="sub1();" size="15"  value="<?php echo $r1['Aqty_app'];?>"></td>
              <td style="border: 1px solid black;"><input type="text" name="txtrqty" id="rqty_1"  class="rqty" size="15"  value="<?php echo $r1['ARec_qty'];?>"></td>
              <td style="border: 1px solid black;"><input type="text" name="txtaunit" id="unit_1"  class="unit" size="15"  value="<?php echo $r1['act_unit'];?>" readonly></td>
             <td style="border: 1px solid black;"><input type="text" name="txtreason" class="reason_1" size="15" id="txtreason"  value="<?php echo $r1['fert_reason'];?>"></td>
             <input type="text" name="txtrate" class="rate" id="rate_1" style="display: none;">
             <input type="text" name="txttot" class="total" id="total_1" style="display: none"><input type="text" name="txtreduce" class="reduce" id="reduce" style="display: none">
         </tr>

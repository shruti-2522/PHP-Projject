...
<body class="sb-nav-fixed">
  ...
  <h2 class="container "><b>IRRIGATION</b></font></h2>
...
<div class="col-sm-1">
<button class="btn btn-success" onclick="window.location.href='add_irrigation.php'"><b>ADD</b></button>
</div>
</div>
</div>
</div>
   ...
   <select name="txtpno"  onchange="showUser(this.value)" class="form-control">
        <option value="">Select plot no.</option>
                ...
                $ses_id=$_SESSION['plot_id'];
                    ...
                    $q=mysqli_query($db,"select distinct(plot_no) from tblirrigation where ses_id='".$ses_id."' and status=0 order by date");
...
function showUser(str) {
  if (str == "") {
    ...
    xmlhttp.open("GET","getPlot3.php?q="+str,true);
    xmlhttp.send();
  }
}
</script>

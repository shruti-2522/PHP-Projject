...
echo $date;
 ...
 $u=$_POST['txtaunit'];
  ...
  mysqli_query($db,"insert into tblgrowthsession(date,gr_name,ppm,aqty,quantity,water,used_solvent,quantity1,Aqty1,unit,purchase_rate,total,ses_id,plot_no,status)values('$date','$item','$rate','$tot','$ses_id','$plot_no','$status')");
...
$date=$_SESSION['date']; 
 ...
 $v=$_POST['txtquantity'];
  ...
  // mysqli_query($db,"insert into tblgrowthsession(date,gr_name,ppm,aqty,quantity,water,used_solvent,quantity1,Aqty1,purchase_rate,total,ses_id,plot_no,status)values('$date','$item','$rate','$tot','$ses_id','$plot_no','$status')");
...
<table class="table" border="1" style="width:97%;">
        ...
        <th  style="border: 1px solid black;"><b>Quantity</b></th>
         <th  style="border: 1px solid black;"><b>Unit</b></th>
           <th  style="border: 1px solid black;"><b>Delete</b></th>
         <th  style="border: 1px solid black;"><b>Edit</b></th>
            </tr>

     	
<?php
  $q1=mysqli_query($db,"select * from tblgrowthsession where ses_id=".$ses_id." and draft_status=0 and gr_id=".$_GET['id']); 
$i=2;
     while ($r=mysqli_fetch_array($q1)) 
     {
      ...
      <td style="border: 1px solid black;">
         <a href="edit_grtable.php?id1=<?php echo $r['gid'];?>&id=<?php echo $_GET['id'];?>"><button class="btn btn-success btn-sm rounded-0" type="submit" name="btnupdate" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button></a>
     </td>

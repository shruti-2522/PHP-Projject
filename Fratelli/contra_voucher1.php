...
<script>
 ...
 <body class="sb-nav-fixed">
        ...
        <?php include('header.php');?>
            <div class="col-sm-7 form-group"><h2><b>CREDIT NOTE FOR CONTRA VOUCHER</b></h2></div><br><br>
  <?php
...
<div class="col-sm-6 form-group">
    <label><font color="black"><b>Account:</b></font></label>
     ...
     <!-- div class="row">
     <div class="col-sm-6 form-group">
    <label><font color="black"><b>current Balance: </b></font></label> 
      <font color="black"><?php echo $r["cbal"];?></font>
    </div>
 -->
...
<div class="row">
 ...
 <?php
   ...
   mysqli_query($db,"UPDATE tblcontra
     SET total='".$add."' WHERE cid=".$r['cid']);
   ?> 

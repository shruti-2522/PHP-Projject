...
<?php  include('header.php');?>
  <div class="col-sm-4 form-group"><h2><b>CROP OBSERVATION</b></h></div>
<br>
...
<div class="col-sm-1">
<button class="btn btn-success" onclick="window.location.href='add_crop.php'"><b>ADD</b></button>
</div>
</div>
</div>
</div>
   ...
   <select name="txtpno"  onchange="showUser(this.value)" class="form-control">
        <option value="">Select plot no.</option>
                ...
                <?php
                    ...
                    $q=mysqli_query($db,"select  distinct plot_no from tblcrop where status=0 and ses_id='".$ses_id."' order by date");
...
function showUser(str) {
  if (str == "") {
    ...
    xmlhttp.open("GET","getPlot5.php?q="+str,true);
    xmlhttp.send();
  }
}
</script>

...
//echo $txtqty;
  ...
  mysqli_query($db,"insert into tblsluryapp(plot_no,pname,date,stime,etime,duration,prunning_day,equipment_used,worker_name,slury_typ,content,quantity,unit,ses_id,status)values('$plot_no','$pname','$txtdate','$txtstime','$txtetime','$txtduration','$txtpday','$txtmachine','$txtworker','$txtslury','$txtcontent','$txtqty1','$txtunit','$ses_id','$status')");
...
?>
	<h2 class="w3-container"><b>ADD SLURRY APLLICATION</b></b></h2>
...
<div class="col-sm-6 form-group">
     ...
     <select name="txtworker" id="worker_name" class="form-control">
        ...
        <select name="txtslury" id="txtslury" class="form-control">
            <option value="">Select Type of Slurry</option>        
  ...
  <div class="col-sm-4 form-group">
       ...
       <input type="text" name="txtqty" id="txtqty" placeholder="Enter quantity" class="form-control">
        </div>
...
<div id="add_data_Modal" class="modal fade">
 <div class="modal-dialog">
  ...
  <h4 class="modal-title"><b>ADD SLURY</h4>

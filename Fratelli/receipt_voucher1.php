...
<script>
 ...
 <body class="sb-nav-fixed">
        ...
        <?php include('header.php');?>
            <div class="col-sm-7 form-group"><h2><b>CREDIT NOTE FOR RECEIPT VOUCHER</b></h2></div><br><br>
  <?php
 ...
 <div class="row">
    <div class="col-sm-6 form-group">
     <font color="black"><b>Purchase no:</b></font>
      <font color="black"> <?php echo $r["receipt_no"];?></font>
    </div>
    <div class="col-sm-6 form-group">
...
<div class="row">
 ...
 <?php
   ...
   mysqli_query($db,"UPDATE tblreceipt
     SET total='$add' WHERE receipt_no=".$r['receipt_no']);
   ?> 

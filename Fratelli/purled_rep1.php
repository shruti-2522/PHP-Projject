...
$q=mysqli_query($db,"select * from tblpurcahse1 where purchase_ledger='".$_GET['str']."' and purchase_no='".$_GET['str1']."' and ses_id=".$ses_id);
while ($r=mysqli_fetch_array($q)) {
  ...
  <div class="col-sm-6 form-group">
    ...
    <div class="row">
     <div class="col-sm-6 form-group">
    <font color="black"><b>Purchase Ledger:</b></font>
     <font color="black"> <?php echo $r["purchase_ledger"];?></font>
    </div>
  </div>
</table>
<br>

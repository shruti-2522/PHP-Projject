...
<div class="col-sm-4 form-group">
   <select name="txtpest" id="txtname" class="form-control" onchange="showUser3(this.value);"  >
               <option value="">Select Pestiscide</option>
      ...
      <div class="col-sm-3">
        <input type="button" class="btn btn-success btn-sm" id="nm-button" onclick="modal();" value="ADD NEW PURCHASE">
      </div>
    </div>
    </div>
    ...
    <div class="show_data"></div>
                  ...
                  <br><br>
<table class="table" border='1' align="center" style="margin-left:1%">
   <thead>
    <tr>    
      <th><b>Batch No.</b></th>
      <th><b>Expiry Date</b></th>
      <th><b>For pest/disease</b></th>
      <th ><b>PHI</b></font></th>
      <th><b>Recommended Qty/lit</b></th>
       <th><b>Used Qty/lit</b></th>
      <th><b>Actual Applied Qty</b></th>
      <th><b>Unit</b></th>
       </tr>
            </thead>
             <tbody>
                  ...
                  <td><input type='text' class='Expdate' name="txtedate" id='edate_1' size="15"></td>
                   <td><input type='text' class='disease' name="txtdisease" id='disease_1' size="15"></td>
                      <td><input type='text' class='phi' name="txtphi" id='phi_1'   size="3"></td>
                       <td><input type='text' class='rqty' name="txtrqty" id='rqty_1'   size="18"></td>
                <td><input type='text' class='uqty' name="txtuqty" id='uqty_1' size="8" onclick='sub2();'></td>
                 
                <td><input type='text' class='aqty' name="txtaqty" id='aqty_1' size="15" > </td>
               <td> <input type='text' name='txtaunit' class='aunit' id='aunit_1' size='3' readonly></td>
                  <td style="border: none; border-right: solid 1px #FFF!important; color:red; border-bottom-style:hidden; "><input type='text' class='rate' name="txtrate" id='rate_1' style="display: none" size="2" > </td>
                   <td  style="border: none;border-right: solid 1px #FFF!important; color:red; border-bottom-style:hidden;"><input type='text' class='item' name="item" id='item_1'  size="7" style="display: none;"> </td>
                     ...
                     <td  style="border: none;border-right: solid 1px #FFF!important; color:red; border-bottom-style:hidden;"><input type='text' class='reduce' name="txtreduce" id='reduce' size="2" style="display: none;"></td>
...
value="<?php echo $sub; ?>" style='display: none;'>
...
$i=2;
     ...
     <td><?php echo $r["act_unit"];?></td>
      <td>
         <a href="edit_distable.php?id1=<?php echo $r['d_id'];?>&id=<?php echo $_GET['id'];?>"><button class="btn btn-success btn-sm rounded-0" type="submit" name="btnupdate" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button></a>
     </td>
     <td><button class="btn btn-danger btn-sm rounded-0 remove" type="button"  title="Delete"><i class="fa fa-trash"></i></button></a>
     </td>
...
<div style="margin-left: 90%"> <!-- 
 ...
 <button type="button" onclick="window.location.href='disease.php'" class="btn btn-success" name="btnmove"><b>SAVE</b></button>
</div>

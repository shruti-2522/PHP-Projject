...
if(isset($_POST["btnreg"]))
{
 ...
 $uni=implode(',', $u1);
  ...
  mysqli_query($db,"insert into tblpurcahse1(purchase_no,date,invoice_no,plot_name,paccount_name,payment_mode,item_name,qty,unit,rate,amount,amount1,narration
,GST,CGST,SGST,ses_id)values('$cno','$txtdate','$txtno','$pname','$txtpname','$txtpm','$a','$qty','$uni','$c','$d','$txttot','$txtnar','$txtdisc','$txtcgst','$txtsgst','$ses_id')");
...
<thead>
            ...
            <tbody>
            <tr class='tr_input'>
                <td><input type='text' class='under' placeholder="Enter Item" size='10' name="txtitem[]" id='under_1'></td>
               
                <td><input type='text' class='qty' placeholder="Enter Quantity" id='qty_1' size='10' name="txtqty[]"></td>
                <td>
                ...
                <td><input type='text' class='rate' id='rate_1' size='10' name="txtrate[]" placeholder="Enter Rate"  onclick="f2()";></td>
                <td><input type='text' class='amount' placeholder="Enter Amount" id='amount_1' name="txtamt[]" size='10'></td>
...
<input type="text" name="txttot" id="total" placeholder="Net Total" class="form-control" onclick="f1();"  required>
</div>
    
    <div class="col-sm-6 form-group">
          <label><font color="black"><b>GST:</b></font></label>
                <select id="txtdisc" name="txtdisc" class="form-control" onchange="calculateAmount(this.value)" required>
 ...
 <script type="text/javascript">
        ...
        $J(document).ready(function(){
            ...
            $J('#addmore').click(function(){
                ...
                var html = "<tr class='tr_input'><td><input type='text' class='under' size='10' placeholder='Enter Item' name='txtitem[]' id='under_"+index+"'></td><td><input type='text' size='10' class='qty'  name='txtqty[]' placeholder='Enter Quantity' id='qty_"+index+"'></td><td><select name='txtunit[]' id='unit_"+index+"' class='unit' size='1' required><option value=''>Select Unit</option><option value='kg'>Kg</option><option value='g'>g</option></select></td><td><input type='text' size='10' name='txtrate[]' placeholder='Enter Rate' class='rate'  id='rate_"+index+"'></td><td><input type='text' size='10' placeholder='Enter Amount' class='amount' id='amount_"+index+"' name='txtamt[]' ></td></tr>";

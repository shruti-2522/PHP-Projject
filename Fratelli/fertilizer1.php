...
<body class="sb-nav-fixed">
  <?php include('header.php');?>
	...
	<h2 class="w3-container "><b>FERTILIZER</b></font></h2>
...
<div class="col-sm-1">
<button class="w3-btn w3-green w3-Medium" onclick="window.location.href='add_fert.php'"><b>ADD</b></button>
</div>
</div>
</div>
</div>
   ...
   <select name="txtpno"  onchange="showUser(this.value)" class="form-control">
        <option value="">Select plot no.</option>
                ...
                $ses_id=$_SESSION['plot_id'];
                    ...
                    $q=mysqli_query($db,"select distinct(plot_no) from tblfertilizer where ses_id='".$ses_id."' and status=0 order by date");
...
function showUser(str) {
  if (str == "") {
    ...
    xmlhttp.open("GET","getPlot.php?q="+str,true);
    xmlhttp.send();
  }
}
</script>

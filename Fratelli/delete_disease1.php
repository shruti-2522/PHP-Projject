...
<body class="sb-nav-fixed">
        ...
        <?php include('header.php');?>
         <div class="col-sm-4 form-group"><h2><b>DELETE APPLICATION</b></h2></div>
...
extract($_POST);
   ...
   $x=0;
   $q=mysqli_query($db,"select * from tbldissession where did=".$_GET['id']);
...
mysqli_query($db,"delete from tbldisease1 where did=".$_GET["id"]);
mysqli_query($db,"delete from tbldissession where did=".$_GET["id"]);

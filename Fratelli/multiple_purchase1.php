...
<?php
  ...
  if(isset($_POST["btncancel"]))
  {
   ...
   $q=mysqli_query($db,"select * from tblp1 where record_status=0 and ses_id=".$ses_id);
   while($r=mysqli_fetch_array($q))
   {
   
     mysqli_query($db,"DELETE FROM tblp1 WHERE id=".$r['id']);

     mysqli_query($db,"DELETE FROM tblmultitem WHERE multi_id=".$r['multi_id']);
...
<div class="col-sm-4 form-group">
   <select name="item_name" id="txtname" class="form-control" onchange="showUser(this.value);"  onkeyup="dropdown();">
      ...
      <div class="col-sm-3">
        <input type="button" class="btn btn-success btn-sm" id="nm-button" onclick="modal();" value="ADD NEW ITEM">
      </div>
    </div>
    </div>
 ...
 <br><br>
<table class="table" align="center" style="margin-left:0%;width: 120%">
   <thead>
    <tr>    
         ...
         <td>
          ...
          <td><input type="text" class="form-control" name="txtno" id="txtno"  onclick="multiply();"  onchange="calculateAmount(this.value)" size="100" required></td>
               ...
               <td   style="border: none;border-right: solid 1px #FFF!important; color:red; border-bottom-style:hidden;"> <input type="text" class="form-control" name="item_type"  id="item_type1" style="display: none;"  size="100"></td>
                    <td  style="border: none;border-right: solid 1px #FFF!important; color:red; border-bottom-style:hidden;">
                        <input type="text" class="form-control" name="dose"  id="dose" placeholder="Enter Dose.." size="100"  style="display: none;" >
                     </td>
...
<div id="add_data_Modal" class="modal fade">
 <div class="modal-dialog">
  ...
  <div class="col-sm-5 form-group">
       ...
       <input type="text" placeholder="Enter Recommended Dose.." class="form-control" name="dose" id="dose1">
      </div>

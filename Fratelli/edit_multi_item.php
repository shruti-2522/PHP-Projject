...
if(isset($_POST["btnadd"]))
{
  ...
  $id=$_GET['id'];
  //echo $txtqty;  
   mysqli_query($db,"update tblmultitem set bill_no='$txtbno',date='$txtdate',supplier='$txtpname',payment_mode='$txtpm',status=0 where multi_id=".$_GET["id"]);

    echo "<script>window.location.href='edit_multi_item1.php?id=$id';</script>";
  exit;
 ...
 $q1=mysqli_query($db,"select * from tblmultitem where multi_id=".$_GET["id"]);
            ...
            <div class="row">
              <div class="col-sm-6 form-group">
                <label><font color="black"><b>Bill No:</b></font></label>
                 <input type="text" class="form-control" name="txtbno" id="txtbno" placeholder="Enter Bill-no"  value="<?php echo $r1['bill_no'];?>" required>
             
              </div>
              <div class="col-sm-6 form-group">
                <label><font color="black"><b>Enter Date:</b></font></label>
              <input type="date" class="form-control" name="txtdate" id="txtdate" placeholder="Enter Date" value="<?php echo $r1['date'];?>" required>
              </div>
            </div> 
...
<div class="col-sm-6 form-group">
        ...
        <Option  value="<?php echo $r1['payment_mode']?>"selected><?php echo $r1['payment_mode']?></option>
        ...
        <Option value="credit">credit</option>
          ...
          <div class="form-group">
              <div align="center">
            <button type="submit"  name="btnadd"  class="btn btn-success col-sm-4"><b>UPDATE</button>

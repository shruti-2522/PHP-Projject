...
<body class="sb-nav-fixed">
        ...
        <?php include('header.php');?>
         <div class="col-sm-4 form-group"><h2><b>DELETE ITEM PURCHASE</b></h2></div>
<?php
if(isset($_POST["btnyes"]))
{
extract($_POST);
mysqli_query($db,"delete from tblmultitem where multi_id=".$_GET["id"]);
mysqli_query($db,"delete from tblp1 where multi_id=".$_GET["id"]);

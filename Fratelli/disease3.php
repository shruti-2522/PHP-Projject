...
<table class="table  w-auto"  style="width: 100%;">
   <thead>
    <tr>  
      <th style="border: 1px solid black;"><b>Item Name.</b></th>  
      <th style="border: 1px solid black;"><b>Qty/liter</b></th>
      <th style="border: 1px solid black;"><b>Total Qty</b></th>
      <th style="border: 1px solid black;"><b>Expiry Date</b></th>
      <th style="border: 1px solid black;"><b>Batch No.</b></th>
       </tr>
            </thead>
             <tbody>
               <tr class='tr_input'>
        ...
        <option value="">Select Pesticide</option>
          ...
          <div id="item_name"></div>
               ...
               <div class="show_data"></div>
                 ...
                 <input type='text' class='rate' name="txtrate" id='rate_1' > 

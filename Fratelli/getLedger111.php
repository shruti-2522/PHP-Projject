...
<table class="table table-borderless table-condensed table-hover" style="margin-left:20%;">
...
?>
 <table id="myTable" border="1" align="center" class="table" style="width:90%; margin-left: 10%;">

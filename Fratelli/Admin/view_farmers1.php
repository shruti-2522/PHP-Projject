...
<div class="row">
 ...
 <div class="col-sm-6">
  
<?php
$q=mysqli_query($db,"select * from tblpolt where plot_id=".$_GET['id']." and status=0");
...
<br><br>
<center><button class="w3-button w3-green w3-round" onclick="window.location.href='show_farmers.php'"><b>BACK</b></button></center>
</div></div></div>

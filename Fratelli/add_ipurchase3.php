...
echo "<script>window.location.href='add_disease1.php';</script>";
   exit;
...
if(isset($_POST["btnadd"]))
{
 ...
 mysqli_query($db,"insert into tblp1(bill_no,date,supplier ,payment_mode,item_name,purchase_rate,qty,unit,exp_date,NOF,batch_no,tot_amount,GST,SGST,CGST,net_total,PHI,disease,item_type,ses_id,status)values('$txtbno','$txtdate','$txtpname','$txtpm','$item_name','$purchase_rate','$txtqty1','$txtunit','$txtedate','$txtno','$txtbatch','$txtamt','$GST','$txtsgst','$txtcgst','$total','$txtphi','$txtpest','$item_type','$ses_id','$status')");
  

echo "<script>window.location.href='add_disease.php';</script>";
  exit;

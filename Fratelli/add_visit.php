...
<body class="sb-nav-fixed">
    ...
    <div class="col-sm-5 form-group"><h1><b>ADD VISIT RECORD</b></h1></div>
 ...
 if(isset($_POST["btndraft"]))
{
  extract($_POST);
  $status=1;
  mysqli_query($db,"insert into tblvisit(plot_no,pname,date,stime,etime,duration,prunning_day,visitor_name,observation,ses_id,status)values('$plot_no','$pname','$txtdate','$txtstime','$txtetime','$txtduration','$txtpday','$txtvisit','$txtobs','$ses_id','$status')");
    ...
    <input type="text" placeholder="Enter End Time.." id="time3" class="form-control" name="txtduration" required>
       ...
       <div class="col-sm-6 form-group">
                <label><font color="black"><b>Name Of  Visitor:</b></font></label>
                  <input  type="text" name="txtvisit" class="form-control" placeholder="Enter Visitor Name" required>
              </div>
            </div>
         ...
         <textarea name="txtobs" class="form-control" placeholder="Enter Observations.." rows="5" cols="15" required></textarea>
    </div>
  </div>
  <br>
   <center>

...
<body class="sb-nav-fixed">
        ...
        <h2 class="container"><font color="black"><b>ALL PURCHASE VOUCHERS</b></font></b></h2>
        <br><br>

 <table class="table" align="center" border="1" style="width:65%">

        <tr >
            <th><b><center>Party Account Name</center></b></th>
           <th><center><b>Payment mode</b></center></th>
...
$q=mysqli_query($db,"select * from tblpurcahse1 where ses_id=".$ses_id);
while ($r=mysqli_fetch_array($q)) {
        ...
        ?>
            ...
            <tr id="<?php echo $r['pid'] ?>">
                <td><font color="blue"><a href="purchase1.php?id=<?php echo $r['pid'];?>"> <?php echo $r["paccount_name"];?></a></font></td>

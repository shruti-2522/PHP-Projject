...
<?php  include('header.php');?>
  ...
  <h2 class="w3-container"><b>PROFIT REPORT</b></font></b></h2>
...
?>
<div id="chart_div" style="height: 370px; width: 70%; margin-left: 10%"></div>
<br><br>
...
<div style="margin-left: 35%">
 <button class="btn btn-success" onclick="window.location.href='proffit_loss_report1.php'">PRINT</div>
 </button>
</div>

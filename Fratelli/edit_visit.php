...
<body class="sb-nav-fixed">
    ...
    <div class="col-sm-5 form-group"><h1><b>EDIT VISIT-RECORDS</b></h1></div>
 <?php
if(isset($_POST["btnsave"]))
{
  extract($_POST);
  mysqli_query($db,"update tblvisit set plot_no='$plot_no',pname='$pname',date='$txtdate',stime='$txtstime',etime='$txtetime',duration='$txtduration',prunning_day='$txtpday',visitor_name='$txtvisit',observation='$txtobs',status=0 where vid=".$_GET["id"]);
   echo "<script>window.location.href='visit.php';</script>";
    exit;
}
  $q1=mysqli_query($db,"select * from tblvisit where vid=".$_GET["id"]);
 ...
 <div class="col-sm-6 form-group">
  <label><font color="black"><b>Duration:</b></font></label>
    <input type="text" placeholder="Enter End Time.." id="time3" class="form-control" name="txtduration" value="<?php echo $r1['duration'];?>">
              ...
              <div class="col-sm-6 form-group">
                <label><font color="black"><b>Name Of Visitor:</b></font></label>
                   <input  placeholder="Enter Corrective Measures.." name="txtvisit" class="form-control"  id="txtvisit" value="<?php echo $r1['visitor_name'];?>">
              </div>
            </div>


              <div class="col-sm-6 form-group">
                <label><font color="black"><b>Observation:</b></font></label>
                   <textarea name="txtobs" class="form-control" rows="5"  id="txtobs"  cols="15" ><?php echo $r1['observation'];?></textarea>
              </div>
            </div>

...
if(isset($_POST["btnsave"]))
{
 ...
 $a = implode(',', $_POST['txtworker']);
  ...
  $a = implode(',', $_POST['txtworker']);
  mysqli_query($db,"update tblother set plot_no='$plot_no',pname='$pname',date='$txtdate',stime='$txtstime',etime='$txtetime',duration='$txtduration',day_after_prunning='$txtpday',work='$a',wages='$b',tot_wages='$total',work_desc='$txtdesc',status=0 where oid=".$_GET["id"]);
...
<div class="container">
 ...
 <input type="text"  id="pno" style="display: none">
     ...
     <div class="row">
          ...
          <input type="Date" placeholder="Enter date.." name="txtdate" class="form-control" id="txtFirst" onchange="myfunction();" value="<?php echo $r1['date'];?>" onclick="selectdate();">
          </div>
          <div class="col-sm-6 form-group">
...
<div class="row">
 ...
 <div class="col-sm-6 form-group">
  ...
  <textarea name="txtdesc" placeholder="Enter work description" class="form-control" ><?php echo $r1['work_desc'];?></textarea>
</div>
</div>

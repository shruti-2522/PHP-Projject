...
<body class="sb-nav-fixed">
    ...
    <div class="col-sm-4 form-group"><h1><b>ADD DRIP</b></h1></div>
...
if(isset($_POST["btndraft"]))
{
  extract($_POST);
  $status=1;
   mysqli_query($db,"insert into tbldrip(plot_no,pname,date,stime,etime,duration,prunning_day,corrective,ses_id,status)values('$plot_no','$pname','$txtdate','$txtstime','$txtetime','$txtduration','$txtpday','$txtcorrective','$ses_id','$status')");

   //mysqli_query($db,"insert into tbldrip(plot_no,pname,date,stime,etime,duration,prunning_day,corrective,observed)values('$plot_no','$pname','$txtdate','$txtstime','$txtetime','$txtduration','$txtpday','$txtcorrective','$txtobserved')");
...
<div class="row">
 ...
 <div class="col-sm-6 form-group">
  <label><font color="black"><b>Duration:</b></font></label>
    ...
    .." id="time3" class="form-control" name="txtduration" required>
              ...
              <div class="col-sm-6 form-group">
                <label><font color="black"><b>Corrective Measures:</b></font></label>
                 <input  placeholder="Enter Corrective Measures.." name="txtcorrective" class="form-control" required>
              </div>
            </div>
